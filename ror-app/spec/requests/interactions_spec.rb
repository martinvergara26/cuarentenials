...
RSpec.describe "/interactions", type: :request do
  ...
  # InteractionsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get interactions_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "renders a JSON response with the new interaction" do
        post interactions_url,
             params: { interaction: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new interaction" do
        post interactions_url,
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested interaction" do
        interaction = Interaction.create! valid_attributes
        patch interaction_url(interaction),
              params: { interaction: new_attributes }, headers: valid_headers, as: :json
        interaction.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the interaction" do
        interaction = Interaction.create! valid_attributes
        patch interaction_url(interaction),
              params: { interaction: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the interaction" do
        interaction = Interaction.create! valid_attributes
        patch interaction_url(interaction),
              params: { interaction: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested interaction" do
      interaction = Interaction.create! valid_attributes
      expect {
        delete interaction_url(interaction), headers: valid_headers, as: :json
      }.to change(Interaction, :count).by(-1)
    end
  end
end
